...
public class UpdateDeleteEmployee extends javax.swing.JFrame {
     ...
     */
    public void clear() {
        jTextFieldImage.setEditable(true);
    ...
    public void HienthiDSNhanVien() {
        ...
        try {
            ...
            while(rs.next()) {
                model.addRow(new Object[] {rs.getString(3), rs.getString(2), rs.getString(4),rs.getString(5),rs.getString(6),rs.getString(7),rs.getString(9),rs.getString(8),rs.getString(9)});
            }
        }catch(Exception ex) {
    ...
    private void initComponents() {
        ...
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons8-upload-50 (2).png"))); // NOI18N
        jButton6.setText("Tải Lên");
                        ...
                        .addGroup(jPanel2Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(jTextFieldImage, javax.swing.GroupLayout.DEFAULT_SIZE, 380, Short.MAX_VALUE))))))
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Họ Tên", "Số Điện Thoại", "Giới Tính", "Email", "Địa Chỉ", "CMT", "Công Việc", "Hình Ảnh", "Tình Trạng"
            }
        ));
        ...
        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons8-search-more-48.png"))); // NOI18N
        ...
        jButton7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons8-restart-30.png"))); // NOI18N
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1470, 950));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String sodt = jTextFieldImage.getText();
        ...
        String congviec = jTextField7.getText();
        String status = (String)jComboBox1.getSelectedItem();
        try {
            Connection con = ConnectionProvider.getCon();
            PreparedStatement ps = con.prepareStatement("update employee set ten=?,gioitinh=?,email=?,diachi=?,cmt=?,hinhanh=?,congviec=?,status=? where sodt=?");
            ps.setString(1,ten);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try {
            Connection con = ConnectionProvider.getCon();
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery("select * from employee where sodt='"+sodt+"'");
            if(rs.first()) {
                jTextFieldImage.setEditable(false);
                jTextFieldImage.setText(rs.getString(2));
                ...
                if(rs.getString(9).contains("Vi")) {
                    
                    jComboBox1.addItem("Đang Làm Việc");
                    jComboBox1.addItem("Đã Nghỉ");
                }
                else {
                    jComboBox1.addItem("Đã Nghỉ");
                    jComboBox1.addItem("Đang Làm Việc");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            Connection con = ConnectionProvider.getCon();
            Statement st = con.createStatement();
            st.executeUpdate("delete from employee where sodt='"+sodt+"'");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        String path = model.getValueAt(rowIndex,7).toString();
        imagePath = path;
        jLabel9.setIcon(imageAdjust(path,null));

...
public class LeavedEmployees extends javax.swing.JFrame {
    ...
    public LeavedEmployees() {
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("select * from employee where status='Đã Nghỉ'");
            while(rs.next()) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 60, 650, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LeavedEmployees.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
